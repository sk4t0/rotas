...
@section("contentheader_title", "Shifts")
@section("contentheader_description", "Shifts listing")
@section("section", "Shifts")
@section("sub_section", "Listing")
@section("htmlheader_title", "Shifts Listing")

@section("headerElems")
@la_access("Shifts", "create")
    <button class="btn btn-success btn-sm pull-right" data-toggle="modal" data-target="#AddModal">Add Shift</button>
@endla_access
@endsection
...
$(function () {
    $("#example1").DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ url(config('laraadmin.adminRoute') . '/shift_dt_ajax') }}",
        language: {
            lengthMenu: "_MENU_",
            search: "_INPUT_",
