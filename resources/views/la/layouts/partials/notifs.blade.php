		...
		<div class="navbar-custom-menu">
			<ul class="nav navbar-nav">
							...
							<ul class="menu">
								<li><!-- start message -->
									<a href="#">
										<div class="pull-left">
											<!-- User Image -->
											<img src="@if(isset(Auth::user()->email)) {{ Avatar::create(Auth::user()->name)->toBase64() }} @else asset('/img/user2-160x160.jpg' @endif" class="img-circle" alt="User Image"/>
										</div>
				...
				<li class="dropdown notifications-menu">
					<!-- Menu toggle button -->
					<a href="#" class="dropdown-toggle" data-toggle="dropdown" id="notifications" aria-haspopup="true" aria-expanded="true">
						<i class="fa fa-bell-o"></i>
						<span id="notificationsCount" aria-hidden="true" class="label label-warning hidden">0</span>
					</a>
					<ul class="dropdown-menu">
						<li class="header">You have <span id="notificationsCount2">0</span> notifications</li>
						<li>
							<!-- Inner Menu: contains the notifications -->
							<ul class="menu" aria-labelledby="notificationsMenu" id="notificationsMenu">
								<li class="dropdown-header"><!-- start notification -->
									No notifications
								</li><!-- end notification -->
							</ul>
						</li>
