...
@section("contentheader_description", "Staff listing")
@section("section", "Staff")
@section("sub_section", "Listing")
@section("htmlheader_title", "Staff Listing")

@section("headerElems")
@la_access("Staff", "create")
    <button class="btn btn-success btn-sm pull-right" data-toggle="modal" data-target="#AddModal">Add Staff</button>
@endla_access
@endsection
...
<div class="modal fade modal-warning" id="AddModal" role="dialog" aria-labelledby="myModalLabel">    <div class="modal-dialog" role="document" style="width: 100%; height: 100%; padding-top: 20px">
        <div class="modal-content">
            ...
            {!! Form::open(['action' => 'LA\StaffController@store', 'id' => 'staff-add-form']) !!}
...
$(function () {
    $("#example1").DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ url(config('laraadmin.adminRoute') . '/staff_dt_ajax') }}",
        language: {
            lengthMenu: "_MENU_",
            search: "_INPUT_",
