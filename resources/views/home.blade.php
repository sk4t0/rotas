...
<div id="features">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-7">
                <h3 class="feature-title">What is IVE ?</h3><br>
                <ol class="features">
                    <li><strong>CMS</strong> (Content Management System) &#8211; Manages data and the website related</li>
                ...
                <h3 class="feature-title">Why IVE ?</h3><br>
                <ol class="features">
                    <li><b>Upload Manager </b>manages project files &amp; images which are integrated with your Module fields.</li>
                    <li><b>Contract Manager </b>manages contracts with hotels, villas etc.</li>
...
<div id="footerwrap">
    <div class="container">
        <div class="col-lg-5">
            <h3>Contact Us</h3><br>
            <p>
                IVE - Intra vel Extra,<br/>
                Web Application Company in Palermo,<br/>
                Via Statella 15,<br/>
                Palermo, Sicilia, Italy - 90100
            </p>
            <div class="contact-link"><i class="fa fa-envelope-o"></i> <a href="mailto:info@intravelextra.com">info@intravelextra.com</a></div>
        </div>
...
<div id="c">
    <div class="container">
        <p>
            <strong>Copyright &copy; 2017. Powered by <a href="https://salvatorenalbone.com"><b>Salvatore Nalbone</b></a>
        </p>
    </div>
</div>
